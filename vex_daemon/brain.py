...
def _system_prompt(recalled: list[dict]) -> str:
    ...
    return (
        ...
        "- No padding: cut 'it is important to note,' 'it should be noted,' 'interestingly.'\n"
        "- No preamble. No closing remarks. Answer straight.\n"
        "- No semicolons. No em-dashes. No marketing adjectives (seamless, robust, powerful).\n"
        "- American spelling.\n\n"
